 ...
 * <p>
 * The zero argument {@code build} and {@code run} methods on subclasses of this will use the
 * {@link java.util.ServiceLoader} to load an engine for the current context classloader. It does not cache engines
 * between invocations. If instantiating an engine is expensive (eg, it creates threads), then it is recommended that
 * the implementation does its own caching by providing the engine using a static provider method.
 */
public interface ReactiveStreamsEngine {
     ...
     *
     * @param graph
     *            The stages to build the publisher from. Will not be empty.
     * @param <T>
     *            The type of elements that the publisher publishes.
     ...
     *
     * @param graph
     *            The graph to build the subscriber from. Will not be empty.
     * @param <T>
     *            The type of elements that the subscriber subscribes to.
     * @param <R>
     *            The result of subscribing to the stages.
     ...
     *
     * @param graph
     *            The graph to build the processor from. If empty, then the processor should be an identity processor.
     * @param <T>
     *            The type of elements that the processor subscribes to.
     * @param <R>
     *            The type of elements that the processor publishes.
     ...
     *
     * @param graph
     *            The graph to build the closed graph from. Will not be empty.
     * @param <T>
     *            The type of the result of running the closed graph.
