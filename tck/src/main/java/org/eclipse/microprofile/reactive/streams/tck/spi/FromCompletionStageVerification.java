...
public class FromCompletionStageVerification extends AbstractStageVerification {
    ...
    @Test
    public void fromCsStageShouldBeEmptyWhenAlreadyRedeemedWithNull() {
        assertEquals(await(
    ...
    @Test
    public void fromCsStageShouldBeEmptyWhenRedeemedWithNullLater() throws InterruptedException {
        CompletableFuture<Integer> future = new CompletableFuture<>();
        CompletionStage<List<Integer>> result = ReactiveStreams.fromCompletionStage(future)
            .toList()
            .run(getEngine());
